...
def ARA(start,goal,E,sizeOfGrid,grid,interval):
    ...
    CameFrom=ImprovePath(start,goal,g,E,OPEN,CLOSED,INCONS,came_from,sizeOfGrid,grid)
    ...
    # time_list=[]
    # time_list.append(finishTime-startTime)
    while E>1:
        E-=0.5
        ...
        CLOSED.clear()
        CameFrom2=ImprovePath(start,goal,g,E,OPEN,CLOSED,INCONS,came_from,sizeOfGrid,grid);
